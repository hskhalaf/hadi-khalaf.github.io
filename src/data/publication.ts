export interface Publication {
  year: string;
  conference: string;
  /** Short venue label for display, e.g. "NeurIPS 2025" */
  venueShort?: string;
  title: string;
  authors: string;
  paperUrl?: string;
...
export const publicationData: Publication[] = [
  {
    ...
    codeUrl: "https://github.com/hskhalaf/Robust-AI-Evaluation-through-Maximal-Lotteries",
  ...
  },
   {
    ...
    authors: "<strong>HK</strong>, Claudio Mayrink Verdun, Alex Oesterling, Himabindu Lakkaraju, Flavio Calmon",
    paperUrl: "https://arxiv.org/abs/2506.19248",
    codeUrl: "https://github.com/hskhalaf/hedging",
    tldr: "We propose hedging as a lightweight and theoretically grounded strategy to mitigate reward hacking.",
    award: "Spotlight Paper",
  ...
  },
  {
    ...
    codeUrl: "https://github.com/maartenbuyl/alignment-discretion",
    tldr: "We risk deploying unsafe AI systems if we ignore their discretion in applying alignment objectives.",
    award: "Best Paper Award at New England NLP Workshop",
