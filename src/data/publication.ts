...
export const publicationData: Publication[] = [
  {
    year: "2025",
    conference: "New England NLP Meeting",
    ...
    tldr: "We formalize the concept of 'alignment discretion' - the latitude given to annotators in judging AI outputs - and show how both human and algorithmic discretion create unexamined risks in current alignment processes.",
  ...
  },
  {
    ...
    authors: "Hadi Khalaf, Claudio Mayrink Verdun, Alex Oesterling, Himabindu Lakkaraju, Flavio du Pin Calmon", // You may want to add the other authors
    ...
    tldr: "We characterize reward hacking in inference-time alignment methods like Best-of-n, introduce Best-of-Poisson for efficient optimization, and present HedgeTune to mitigate reward hacking through strategic hedging.",
