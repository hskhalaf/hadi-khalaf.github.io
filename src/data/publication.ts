...
export const publicationData: Publication[] = [
   {
    ...
    tldr: "We characterize reward hacking in inference-time alignment methods like Best-of-n, introduce an efficient approximation of the optimal RLHF solution, and propose a hedging strategy to mitigate reward hacking.",
