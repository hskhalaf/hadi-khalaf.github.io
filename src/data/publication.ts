...
export const publicationData: Publication[] = [
   {
    ...
    tldr: "We characterize reward hacking in inference-time alignment methods like Best-of-n, introduce Best-of-Poisson as an efficient approximation of the optimal RLHF solution, and propose a grounded hedging strategy to mitigate reward hacking.",
  ...
  },
  {
    ...
    tldr: "We show that we risk deploying unsafe AI systems if we ignore their discretion in applying alignment objectives.",
